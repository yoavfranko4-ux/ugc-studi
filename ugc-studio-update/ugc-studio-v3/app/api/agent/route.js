...
function getDefaultScenes(productName, applicationArea, productDesc) {
  ...
  return [
    ...
    },
    {
      ...
      kling_prompt: `Avatar in the aspirational contextual moment for ${productName}, closed-lip warm smile forms gradually with eyes softening, small subtle nod, environment alive behind — soft-focus periphery motion of the setting, product naturally visible. ${PRODUCT_LOCK} ${STABLE}`,
