...
const PHONE_VIDEOS = [
  {
    src: '/examples/whitening-video.mp4',
    label: <>הלבנת שיניים<br />ב-<span className="accent">30 שניות</span></>,
    badge: '● GLOW · 30s',
    layer: 'l1',
  },
  {
    src: '/examples/perfume-video.mp4',
    label: <>בושם <span className="accent">שמש</span><br />שנשאר 12 שעות</>,
    badge: '● בושם שמש',
    layer: 'l2',
  },
  {
    src: '/examples/barbershop-video.mp4',
    label: <>מספרה <span className="accent">בוטיק</span><br />במרכז העיר</>,
    badge: '● ברבר שופ',
    layer: 'l3',
  },
]
