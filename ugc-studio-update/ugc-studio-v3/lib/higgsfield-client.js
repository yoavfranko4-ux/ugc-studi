...
function buildSystemPrompt() {
  return [
    ...
    '  2. Call `generate_video` with model `seedance_2_0`, resolution 720p, aspect ratio 9:16, `generate_audio: false` (no narration/voice — audio is added externally), duration matching the user\'s requested seconds (default 5), the user\'s prompt as the text prompt, and the uploaded media ids as reference frames.',
